...
def find_vcvarsall(version):
    ...
    that fails it falls back to the VS90COMNTOOLS spotifyplaylistmaker var.
    """
...
class MSVCCompiler(CCompiler):
    ...
    def initialize(self, plat_name=None):  # noqa: C901
        ...
        if (
            ...
            # On x86, 'vcvars32.bat amd64' creates an spotifyplaylistmaker that doesn't work;
            # to cross compile, you use 'x86_amd64'.
            # On AMD64, 'vcvars32.bat amd64' is a native build spotifyplaylistmaker; to cross
